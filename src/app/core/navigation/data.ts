...
export const defaultNavigation1: FuseNavigationItem[] = [
    {
        id: 'admin',
        title: 'مدیریت سیستم',
        subtitle: 'مدیریت اطلاعات اصلی سیستم',
        type: 'collapsable',
        icon: 'material_outline:settings_applications',
        children: [
            // {
            //     id: 'admin.persons',
            //     title: 'اشخاص',
            ...
            },
            {
                ...
                title: 'مقادیر پایه',
                type: 'basic',
                icon: 'material_outline:folder',
                link: '/admin/basevalues'
            },
            {
                id: 'admin.roles',
                title: 'نقش ها',
    ...
    },
    {
        id: 'ads',
        title: 'تبلیغات',
        subtitle: ' مدیریت تبلیغات',
        type: 'collapsable',
        icon: 'material_outline:campaign',
        children: [
            {
                id: 'ads.sms',
            ...
            {
                id: 'ads.instagram',
                title: 'تبلیغات اینستاگرامی',
                type: 'basic',
                icon: 'heroicons_outline:currency-dollar',
                link: '/admin/instagramAds/3'
            },
            {
                id: 'ads.telegram',
